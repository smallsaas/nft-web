    ...
    function listItem (item, index){
        ...
        return (
            <Row align='left' justify='left' key={`${index}_item`} style={{marginBottom:'8px'}}>
                <Col flex="100px" align='center' justify='center'>
                    <div className='padding-t-b-10' style={{width: '100%', height: '100%'}}>{item.label}</div>
                </Col>
                <Col flex="100px" style={{ marginRight: '5px' }}>
                    <div className='padding-t-b-10' style={{width: '100%', paddingLeft: '5px',border: '1px solid #ccc'}}><CompxValue {...item.value} /></div>
                </Col>
